...
strings = ['a', 'b', 'c', 'd']
# 4*4 = 16 bytes f storage is used
...
#clear()     Removes all the elements fromt the list
#copy()      Returns a copy of the list
#count()     Returns the number of elements eith the speified value
#extend()    Add the elements of a list (or any iterable), to the end of the current list
#index()     Returns the index of the first element with the specified value
#insert()    Adds an element at the specified position
#pop()       Removes the element at the specified position
#remove()    Removes the fitrst item eith the specified position
#reverse()  Reverses the order of the list
#sort()     sorts the list

#list objects are implemented as arrays.
#They are optimized for fast fixed-length operations and incur O(n) momory movement costs  for pop(0) and insert(0,v)
#operstions which change both the size and position of the underlying data representstion.
...
# In Python, lists are implemented as dynamic arrays, and the time complexity for various operations can be described using Big O notaion. Here are the common operations and their time complexities:
