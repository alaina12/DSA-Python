...
class BinarySearchTree:
	...
	#Inorder Traversa; (we get sorted order of elements in tree)
		...
		while currentNode:
			if data < currentNode.data:
				...
				if parentNode == None:
					...
					# if parent < current, make right chile a right child of the parent
					elif currentNode.data > parentNode.data:
						parentNode.right = currentNode.right

			#option 3: Right chid that has a left child
		else:
			#find the Right child;s left most child
			leftmost = currentNode.right.lefy
